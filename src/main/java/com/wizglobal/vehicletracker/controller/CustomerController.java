...
public class CustomerController extends BasePage implements Serializable {
	 ...
	 * 
	 * @return for success navigates to view this customer. '/customers/view.jsf' or null to remail in current page.
	 */
	...
	public String saveCurrentCustomerChanges() {
		if( currentCustomer == null ) {
			...
			try {
				...
				addErrorgMessage(
						"Customer changes not save due to data access error. Please try again.", null );
			}
		}
		return null;
	}
